-- Tạo database nếu chưa có và chuyển context
...
-- 1. Bổ sung các cột chi tiết cho phần "Nôn"
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE Name = N'Non_SoLan' AND Object_ID = Object_ID(N'dbo.DanhGia_TieuHoa'))
    ALTER TABLE dbo.DanhGia_TieuHoa ADD Non_SoLan VARCHAR(100) NULL;
GO
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE Name = N'Non_SoLuong' AND Object_ID = Object_ID(N'dbo.DanhGia_TieuHoa'))
    ALTER TABLE dbo.DanhGia_TieuHoa ADD Non_SoLuong VARCHAR(100) NULL;
GO
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE Name = N'Non_ChatNon' AND Object_ID = Object_ID(N'dbo.DanhGia_TieuHoa'))
    ALTER TABLE dbo.DanhGia_TieuHoa ADD Non_ChatNon NVARCHAR(255) NULL;
GO
-- Lưu ý: Cột Non_ChiTiet cũ có thể không cần dùng nữa

-- 2. Bổ sung các cột chi tiết cho phần "Đại tiện"
-- Nhóm chi tiết 1
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE Name = N'DaiTien_SoLuong_ChiTiet' AND Object_ID = Object_ID(N'dbo.DanhGia_TieuHoa'))
    ALTER TABLE dbo.DanhGia_TieuHoa ADD DaiTien_SoLuong_ChiTiet VARCHAR(100) NULL;
GO
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE Name = N'DaiTien_MauSac' AND Object_ID = Object_ID(N'dbo.DanhGia_TieuHoa'))
    ALTER TABLE dbo.DanhGia_TieuHoa ADD DaiTien_MauSac NVARCHAR(255) NULL;
GO
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE Name = N'DaiTien_Khac_ChiTiet' AND Object_ID = Object_ID(N'dbo.DanhGia_TieuHoa'))
    ALTER TABLE dbo.DanhGia_TieuHoa ADD DaiTien_Khac_ChiTiet NVARCHAR(MAX) NULL;
GO
-- Nhóm chi tiết 2 (Táo bón)
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE Name = N'DaiTien_SoNgayChuaDaiTien' AND Object_ID = Object_ID(N'dbo.DanhGia_TieuHoa'))
    ALTER TABLE dbo.DanhGia_TieuHoa ADD DaiTien_SoNgayChuaDaiTien VARCHAR(100) NULL;
GO
-- Nhóm chi tiết 3
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE Name = N'DaiTien_SoLan' AND Object_ID = Object_ID(N'dbo.DanhGia_TieuHoa'))
    ALTER TABLE dbo.DanhGia_TieuHoa ADD DaiTien_SoLan VARCHAR(100) NULL;
GO
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE Name = N'DaiTien_SoLuong_Phan' AND Object_ID = Object_ID(N'dbo.DanhGia_TieuHoa'))
    ALTER TABLE dbo.DanhGia_TieuHoa ADD DaiTien_SoLuong_Phan VARCHAR(100) NULL;
GO
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE Name = N'DaiTien_TinhChatPhan' AND Object_ID = Object_ID(N'dbo.DanhGia_TieuHoa'))
    ALTER TABLE dbo.DanhGia_TieuHoa ADD DaiTien_TinhChatPhan NVARCHAR(255) NULL;
GO
-- Lưu ý: Cột DaiTien_ChiTiet cũ có thể không cần dùng nữa